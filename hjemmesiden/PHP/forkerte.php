<?php
	...
	$sql = "SELECT navnbruger, mailbruger, mobilbruger, har_rigtige, Monthbruger, vinder FROM bruger WHERE (har_rigtige = 0 AND date_format(Monthbruger, '%M') = date_format(NOW(), '%M'))";
